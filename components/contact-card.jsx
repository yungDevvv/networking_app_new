...
import { ContactRound, EllipsisVertical, Info, Mail, MapPin, Phone, Search } from 'lucide-react';
      ...
      <div className={`bg-white shadow-md rounded-lg p-4 border border-gray-100 relative`}>
         ...
         <div className="relative text-right">
            <DropdownMenu>
               ...
               <DropdownMenuContent>
                  <DropdownMenuItem>
                     <Link href={`/profile/#hash`} className="">Näytä profiili</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => {
                     onOpen("choose_network", { network_id: 1 })
                     
                     }}>
                     Kutsu verkostoon
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => onOpen("choose_network", { network_id: 1 })}>
                     Kutsu ryhmään
                  </DropdownMenuItem>
               </DropdownMenuContent>
            </DropdownMenu>
            ...
            {isMenuOpen && (
               <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg text-left">
                  <ul className="py-1">
                     ...
                     <li>
                        <button onClick={() => onOpen("choose_network", { network_id })} className="block px-4 py-2 text-gray-800 hover:bg-gray-100 w-full text-left">Kutsu verkostoon</button>
                     </li>
                     <li>
                        <button onClick={() => {
                          
                           onOpen("choose_network", { network_id })
